...
from HWtask10_1 import Mammal, Bird, Fish, Animal
...
if __name__ == '__main__':
    ...
    animal2 = AnimalFabric(animal_class='mammal', name='собака', age=10, hair='длинная шерсть', voice='гав-гав', color='черный').get_info_animal()
